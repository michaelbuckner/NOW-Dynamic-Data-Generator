var NowDataGenerator = Class.create();

NowDataGenerator.prototype = Object.extendsObject(NowAbstractDataGenerator, {
    ...
    createIncidentWithKB: function(shortDescription) {
        ...
        try {
            ...
            // Step 5: Add comments, work notes to the incident
